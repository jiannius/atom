<div class="youtube-menu bg-white dark:bg-zinc-700 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-600" x-init="$el.shouldShow = (editor) => (editor?.isActive('youtube'))">
    <div class="p-1 flex items-center gap-1 flex-wrap">
        @foreach ([
            ...
            <atom:tiptap.menu.button x-on:click="commands().updateAttributes('youtube', {
                width: {{ js($dim[0]) }},
                height: {{ js($dim[1]) }},
            })">
