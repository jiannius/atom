...
@class([
    'group/radio',
    $variant === 'card'
        ? 'flex py-3 px-4 border border-zinc-200 dark:border-zinc-700 shadow-sm rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-700 has-checked:bg-zinc-100 dark:has-checked:bg-zinc-700'
        : 'block',
])
data-atom-radio>
